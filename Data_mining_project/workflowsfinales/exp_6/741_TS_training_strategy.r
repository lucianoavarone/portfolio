...
PARAM  <- list()
PARAM$experimento <- "TS7410_sinmanual_202109"

PARAM$exp_input  <- "FE7310_sinmanual_202109"
...
PARAM$train$undersampling  <- 0.25  # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA
